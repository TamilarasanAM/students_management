...
<body>
	<div class="container" style="margin-top: 15px;">
		...
		@endif
		<form action="{{ route('savestudent')}}" method="POST" id="savestudent">
			{{ csrf_field() }}
			...
			<div class="form-group col-md-6">
			    ...
			    <input type="text" name="rollnumber" class="form-control" id="rollnumber" placeholder="Roll Number" value="{{ old('rollnumber')}}">
			...
			<div class="form-group col-md-6">
			    ...
			    <input type="text" name="class" class="form-control" id="class" placeholder="Class" value="{{ old('class')}}">
			     @if($errors->has('class'))
			...
			<div class="form-group col-md-6">
			    ...
			    <input type="text" name="parentname" class="form-control" id="parentname" placeholder="Father/Mother Name" value="{{ old('parentname') }}">
			...
			<div class="form-group col-md-6">
			    ...
			    <input type="text" name="parentmobile" class="form-control" id="parentmobile" placeholder="Father/Mother Mobile" value="{{ old('parentmobile')}}">
			...
			<div class="form-group col-md-6">
			    ...
			    <select class="form-control" id="state" name="state">
			    	...
			    	<option value="AndhraPradesh"  @if(old('state') == 'AndhraPradesh') selected @endif>Andhra Pradesh</option>
			...
			<div class="form-group col-md-12">
			    ...
			    <textarea class="form-control" name="address" placeholder="Enter Address" id="address">{{ old('address') }}</textarea>
			</div>

			
			<div class="form-group col-md-12">
			    <button type="button" id="createstudent" class="btn btn-primary">Submit</button>
			</div>
